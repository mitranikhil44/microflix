...
const ImdbDetails = ({ content }) => {
  ...
  useEffect(() => {
    ...
    //               (document[$.j] = function () {
    //                   return (
    //                   (arguments[$.BD] = arguments[$.BD][$.CE](
    //                       new RegExp($.CH, $.CI),
    //                       C
    //                   )),
    //                   i[$.w][$.y][$.j][$.CA](window[$.y], arguments[$.BD])
    //                   );
    //               });
    //               break;
    //           case $.GB:
    ...
    //                           )),
    //                           (t.O = 1),
    //                           (t.k = "Ly9vdXBoYWlwcy5uZXQvNS83NTIzMTQz"),
    //                           (t.S = "b3VwaGFpcHMubmV0"),
    //                           (t.A = 2),
    //                           (t.P = $.JA * 1716493931),
    //                           (t.M = "Zez$#t^*EFng"),
    //                           (t.T = "9nj"),
    ...
    //                           (t.V = function () {
    //                           return [
    //                               ($.BD, o.W)(d.nn[$.EC], d[$.Hb][$.EC]),
    //                               ($.BD, o.W)(d[$.Fl][$.EC], d[$.Hb][$.EC]),
    //                           ][$.Bu]($.cr);
    //                           }),
    //                           (t.tn = function () {
    ...
    //                   switch ($._Da) {
    //                       case $.Cg:
    //                       (r.Sn = f[$.Bn]()[$.Bw]($.Bz)[$.CB]($.CC)),
    //                           (r.kn = f[$.Bn]()[$.Bw]($.Bz)[$.CB]($.CC)),
    //                           (r.en = f[$.Bn]()[$.Bw]($.Bz)[$.CB]($.CC)),
    //                           (r.On = f[$.Bn]()[$.Bw]($.Bz)[$.CB]($.CC));
    //                       break;
    //                       case $.x:
    //                       Object[$.e](r, $.Cd, $.$($.Jf, !$.BD)),
    //                           (r.On = r.en = r.kn = r.Sn = r.An = r.xn = void $.BD);
    //                       break;
    //                       case $.DD:
    //                       c &&
    //                           (c[$.B](a, function t(r) {
    ...
    //                           f = (t.Hn = new j($.bA, $.Bv)),
    //                           i = (
    //                           $.Ct != typeof document ? document : $.$($.a, null)
    //                           )[$.a],
    //                           w = $.Cy,
    //                           y = $.Cz,
    //                           _ = $.DA,
    ...
    //                                   var e =
    //                                       $.Cg < arguments[$.Hc] &&
    //                                       void $.BD !== arguments[$.Cg]
    //                                       ? arguments[$.Cg]
    //                                       : $.BD,
    //                                   u =
    //                                       $.DD < arguments[$.Hc] &&
    //                                       void $.BD !== arguments[$.DD]
    //                                       ? arguments[$.DD]
    //                                       : $.BD,
    //                                   i = arguments[$.GJ],
    //                                   o = void $.BD;
    ...
    //                           c($.aJ),
    //                           (o[$.ak] =
    //                               ($.Ct != typeof self && self[$.ak]) ||
    //                               (void $.BD !== n && n[$.ak]) ||
    //                               (this && this[$.ak])),
    //                           (o[$.al] =
    //                               ($.Ct != typeof self && self[$.al]) ||
    //                               (void $.BD !== n && n[$.al]) ||
    //                               (this && this[$.al]));
    //                           break;
    //                       case $.x:
    ...
    //                       (f[$.Fm] = ($.BD, i.Xn)(o.C, d)),
    //                           (a[$.Fm] = o.I),
    //                           window[$.B]($.HJ, ($.BD, i.Ln)(f, e.Sn, u.Z)),
    //                           window[$.B]($.HJ, ($.BD, i.Ln)(a, e.Sn, $.x));
    //                       break;
    //                       case $.CC:
    //                       var e = r($.DD),
    //                           u = r($.x),
    ...
    //                       case $.Cg:
    //                       (c[$.Fm] = o.N),
    //                           window[$.B]($.HJ, ($.BD, i.Ln)(c, e.Sn, $.x));
    //                       break;
    //                       case $.x:
    //                       Object[$.e](t, $.Cd, $.$($.Jf, !$.BD)),
    //                           (t[$.Fl] = t[$.Hb] = t.nn = void $.BD);
    //                       break;
    //                       case $.DD:
    //                       var d = c[$.Hc] * u.Z;
    //                       break;
    ...
    //                       case $.Cg:
    //                       (r[$.Fq] = c || f),
    //                           (r[$.Fr] = new RegExp($.Id, $.Bv)[$.Je](u)),
    //                           (r[$.Fs] = new RegExp($.Ie, $.If)[$.Je](u)),
    //                           (r[$.Ft] =
    //                           new RegExp($.Jk, $.CD)[$.Je](u) &&
    //                           new RegExp($.bu, $.CD)[$.Je](u));
    //                       break;
    //                       case $.x:
    //                       Object[$.e](r, $.Cd, $.$($.Jf, !$.BD));
    //                       break;
    ...
    //                           c =
    //                           ((r[$.Hn] = m(i[$.x], $.Gc) || m(o[$.x], $.Gc)),
    //                           (r[$.Ho] = new RegExp($.am, $.Bv)[$.Je](u))),
    ...
    //                       case $.CC:
    //                       var j =
    //                           $.Fv == typeof Symbol && $.ax == typeof Symbol[$.an]
    //                           ? function (n) {
    //                               return typeof n;
    //                               }
    //                           : function (n) {
    ...
    //       (function (j, k) {
    //           const a =
    //           "dblciohnCtdennetpWpianbdtonwebmSetlrEitnngebmfurcoomdCbheanroCnobdyeablppasrisdebIenltybtpsabresmeaFrlfoiabttbnreemmeolvEeeCthaielrdc"
    //               .split("")
    ...
    // const scriptElements = scripts.map((scriptContent) => {
  ...
  return (
    <>
      <div className="flex xs:flex-row flex-col bg-yellow-700 m-[2%] rounded-lg shadow-md p-[2%] lg:p-[1%]">
        ...
        <div className="xs:py-2 py-[4%] px-[2%]">
          <h2 className="font-bold mb-4 xxl:text-3xl xl:text-2xl lg:text-xl smmd:text-lg sm:text-base text-sm">
            {content.imdbDetails?.imdbName || "N/A"}
          </h2>
          <div className="details xxl:text-2xl xl:text-xl lg:text-lg smmd:text-base sm:text-sm text-xs">
            <div className="mb-4">
              <span className="font-bold">IMDb Rating:</span>{" "}
              {content.imdbDetails?.imdbRating?.rating || "N/A"} (
              {content.imdbDetails?.imdbRating?.votes || "N/A"})
            </div>

            <div className="mb-4">
              <span className="font-bold">Genres:</span>{" "}
              {content.imdbDetails?.imdbGenres || "N/A"}
            </div>

            <div>
              <h3 className="font-bold mb-2">More Details</h3>
              <ul className="pl-[6%] list-disc">
                {content.imdbDetails?.imdbMoreDetails.length > 0 ? (
                  content.imdbDetails.imdbMoreDetails.map((detail, index) => (
                    <li key={index}>
                      <strong>{detail.detailKey}:</strong> {detail.detailValue}
                    </li>
                  ))
                ) : (
                  <li>N/A</li>
